...
code = ",[" + C(3,2,"t[p]=(t[p]+1)%4;") + C(1,2,"t[p]=(t[p]+3)%4;") + C(2,3,"p--;") + C(0,3,"p++;") + C(2,2,"putchar(t[p]);") + C(0,2,"ch=getchar(); t[p]=ch==EOF?0:ch%4;") + C(3,1,"while(t[p]!=0){") + C(1,1,"}") + ",]"
...
print("SUCCESS: The Final Bug-Free πthon Compiler Generated!")
