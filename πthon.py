...
code = ",[" + C(3,2,"t[p]=(t[p]+1)%4;") + C(1,2,"t[p]=(t[p]+3)%4;") + C(2,3,"p--;") + C(0,3,"p++;") + C(2,2,"putchar(t[p]);") + C(0,2,"t[p]=getchar();") + C(3,1,"while(t[p]!=0){") + C(1,1,"}") + ",]"
...
print("SUCCESS: The Ultimate 8-Command πthon Compiler Generated!")
